            ...
            if(field == 'solutions') {
              //console.log(field);
                if(subField == 'monitoring') {
                  ...
                  subSubMenu.innerHTML =  '<li id="sub__solutions__monitoring"  class="menu__item"><a href="medical-monitoring.html" title="" class="menu__link">medical monitoring</a></li>'
                                        +'<li id="sub__solutions__monitoring"  class="menu__item"><a href="industrial-monitoring.html" title="" class="menu__link">industrial monitoring</a></li>';
                } else if (subField == 'automation') {
                  console.log(2);
                  subfieldsArray = ['automatic product sorting', 'energy consumption optimization'];
                  subSubMenu.innerHTML =  '<li id="sub__solutions__monitoring"  class="menu__item"><a href="industrial-automation-main.html#automatic-product-sorting" title="" class="menu__link">automatic product sorting</a></li>'
                                        +'<li id="sub__solutions__monitoring"  class="menu__item"><a href="industrial-automation-main.html#energy-consumption-optimization" title="" class="menu__link">energy consumption optimization</a></li>';
